...
func (vsc *VXSocialCreate) check() error {
	if _, ok := vsc.mutation.CreatedBy(); !ok {
		return &ValidationError{Name: "created_by", err: errors.New(`ent_work: missing required field "VXSocial.created_by"`)}
	}
	if _, ok := vsc.mutation.UpdatedBy(); !ok {
		return &ValidationError{Name: "updated_by", err: errors.New(`ent_work: missing required field "VXSocial.updated_by"`)}
	}
	if _, ok := vsc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent_work: missing required field "VXSocial.created_at"`)}
	}
	if _, ok := vsc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent_work: missing required field "VXSocial.updated_at"`)}
	}
	if _, ok := vsc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent_work: missing required field "VXSocial.deleted_at"`)}
	}
	if _, ok := vsc.mutation.AppID(); !ok {
		return &ValidationError{Name: "app_id", err: errors.New(`ent_work: missing required field "VXSocial.app_id"`)}
	}
	if _, ok := vsc.mutation.OpenID(); !ok {
		return &ValidationError{Name: "open_id", err: errors.New(`ent_work: missing required field "VXSocial.open_id"`)}
	}
	if _, ok := vsc.mutation.UnionID(); !ok {
		return &ValidationError{Name: "union_id", err: errors.New(`ent_work: missing required field "VXSocial.union_id"`)}
	}
	if _, ok := vsc.mutation.Scope(); !ok {
		return &ValidationError{Name: "scope", err: errors.New(`ent_work: missing required field "VXSocial.scope"`)}
	}
	if v, ok := vsc.mutation.Scope(); ok {
		if err := vxsocial.ScopeValidator(v); err != nil {
			return &ValidationError{Name: "scope", err: fmt.Errorf(`ent_work: validator failed for field "VXSocial.scope": %w`, err)}
		}
	}
	if _, ok := vsc.mutation.SessionKey(); !ok {
		return &ValidationError{Name: "session_key", err: errors.New(`ent_work: missing required field "VXSocial.session_key"`)}
	}
	if _, ok := vsc.mutation.AccessToken(); !ok {
		return &ValidationError{Name: "access_token", err: errors.New(`ent_work: missing required field "VXSocial.access_token"`)}
	}
	if _, ok := vsc.mutation.RefreshToken(); !ok {
		return &ValidationError{Name: "refresh_token", err: errors.New(`ent_work: missing required field "VXSocial.refresh_token"`)}
	}
	if _, ok := vsc.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent_work: missing required field "VXSocial.user_id"`)}
	}
	if _, ok := vsc.mutation.UserID(); !ok {
		return &ValidationError{Name: "user", err: errors.New(`ent_work: missing required edge "VXSocial.user"`)}
	}
	return nil
}
...
func (u *VXSocialUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent_work: missing options for VXSocialCreate.OnConflict")
	}
...
func (u *VXSocialUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent_work: OnConflict was set for builder %d. Set it on the VXSocialCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent_work: missing options for VXSocialCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
