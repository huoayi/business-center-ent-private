...
func (lrc *LoginRecordCreate) check() error {
	if _, ok := lrc.mutation.CreatedBy(); !ok {
		return &ValidationError{Name: "created_by", err: errors.New(`ent_work: missing required field "LoginRecord.created_by"`)}
	}
	if _, ok := lrc.mutation.UpdatedBy(); !ok {
		return &ValidationError{Name: "updated_by", err: errors.New(`ent_work: missing required field "LoginRecord.updated_by"`)}
	}
	if _, ok := lrc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent_work: missing required field "LoginRecord.created_at"`)}
	}
	if _, ok := lrc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent_work: missing required field "LoginRecord.updated_at"`)}
	}
	if _, ok := lrc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent_work: missing required field "LoginRecord.deleted_at"`)}
	}
	if _, ok := lrc.mutation.Ua(); !ok {
		return &ValidationError{Name: "ua", err: errors.New(`ent_work: missing required field "LoginRecord.ua"`)}
	}
	if _, ok := lrc.mutation.IP(); !ok {
		return &ValidationError{Name: "ip", err: errors.New(`ent_work: missing required field "LoginRecord.ip"`)}
	}
	if _, ok := lrc.mutation.Way(); !ok {
		return &ValidationError{Name: "way", err: errors.New(`ent_work: missing required field "LoginRecord.way"`)}
	}
	if _, ok := lrc.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`ent_work: missing required field "LoginRecord.user_id"`)}
	}
	if _, ok := lrc.mutation.UserID(); !ok {
		return &ValidationError{Name: "user", err: errors.New(`ent_work: missing required edge "LoginRecord.user"`)}
	}
	return nil
}
...
func (u *LoginRecordUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent_work: missing options for LoginRecordCreate.OnConflict")
	}
...
func (u *LoginRecordUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent_work: OnConflict was set for builder %d. Set it on the LoginRecordCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent_work: missing options for LoginRecordCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
